...
class FHoloPlayScalabilityManager;
...
public:
	...
	bool LoadDLL()
	{
		...
		FString DllPath = FPaths::Combine(FPaths::ProjectDir(), TEXT("Plugins/HoloPlay/ThirdParty/HoloPlay/Bin/")) / PlatformName;
 ...
 *
 * @brief	A holo play runtime module.
...
public:
	 ...
	 *
	 * @brief	Gets holo play display manager
	 * 			It is provided calibration data from the device
	 *
	 * @returns	The holo play display manager.
	 */
	 ...
	 *
	 * @brief	Gets holo play command line manager
	 *
	 * @returns	The holo play command line manager.
	 */

	virtual TSharedPtr<FHoloPlayCommandLineManager> GetHoloPlayCommandLineManager() override;

	/**
 * @fn	virtual TSharedPtr<FHoloPlayScalabilityManager> FHoloPlayRuntimeModule::GetHoloPlayScalabilityManager() override;
 *
 * @brief	Gets holo play Scalability line manager
 *
 * @returns	The holo play Scalability line manager.
 */

	virtual TSharedPtr<FHoloPlayScalabilityManager> GetHoloPlayScalabilityManager() override;
...
private:
	...
	TSharedPtr<FHoloPlayScalabilityManager> HoloPlayScalabilityManager;
