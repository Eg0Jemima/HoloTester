 ...
 *
 * @brief	A holo play player interface. Should be inmplemented at all children
 */
...
public:
	 ...
	 *
	 * @brief	Gets current holo play mode type
	 *
	 * @returns	The current holo play mode type.
	 */
	...
	/**
	 * @fn	virtual TSharedPtr<FHoloPlayCommandLineManager> IHoloPlayPlayer::GetHoloPlayScalabilityManager() = 0;
	 *
	 * @brief	Gets holo play command line manager
	 *
	 * @returns	The holo play command line manager.
	...
	virtual TSharedPtr<FHoloPlayScalabilityManager> GetHoloPlayScalabilityManager() = 0;
...
public:
	TWeakObjectPtr<AHoloPlayCapture> EditorHoloPlayCapture;
	TWeakObjectPtr<AHoloPlayCapture> GameHoloPlayCapture;
};